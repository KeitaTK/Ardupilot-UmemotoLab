# 00000078_fixed - EKF リプレイ検証レポート

## 入力データ
- リプレイ結果CSV: analysis/replay/results/runs/00000078/00000078_bin_result.csv
...
- サンプル数: 10283
- 処理時間: 102.82 秒
- 周波数推定誤差（MAE）: 0.121965 Hz
- 周波数推定誤差（最大）: 0.557000 Hz
- 波形再現誤差（RMSE）: 1.892424
- 波形相関係数: 0.172366
- 高周波抑制指標（PRX/PLX差分比）: 4.930469 （小さいほど良い）
- スイッチ有効率: 1.0000
