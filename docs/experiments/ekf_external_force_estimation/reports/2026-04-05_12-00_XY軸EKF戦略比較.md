# XY軸EKF戦略比較レポート (2026-04-05)

## 論理フロー（問題提起→解法→実験→結果→考察→残課題→次提案）
- 前レポートからの問題提起: 3軸融合での軸不整合を避け、XYのみで安定化したい
- 本レポートの解決手法: XY軸マスク・SW hold・Qwスイープを併用比較
...
- 前後関係: 前段 [2026-04-04_23:55_二成分長周期モデル検証.md](./2026-04-04_23:55_二成分長周期モデル検証.md) / 次段 [2026-04-05_13:30_単一周波数EKF検証.md](./2026-04-05_13:30_単一周波数EKF検証.md)
## 目的
...
- 生成物: [analysis/replay/results/diagnostics/xy_ekf_2026-04-05/](../../../../analysis/replay/results/diagnostics/xy_ekf_2026-04-05/)
