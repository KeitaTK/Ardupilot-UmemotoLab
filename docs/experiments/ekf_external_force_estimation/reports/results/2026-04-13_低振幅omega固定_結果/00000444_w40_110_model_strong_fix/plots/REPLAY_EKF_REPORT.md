# 00000444_w40_110_model_strong_fix - EKF リプレイ検証レポート

## 入力データ
- リプレイ結果CSV: docs/experiments/ekf_external_force_estimation/reports/2026-04-13_low_amp_holdomega_fix/00000444_w40_110_model_strong_fix/00000444_w40_110_model_strong_fix_result.csv
...
- サンプル数: 7000
- 処理時間: 69.99 秒
- 周波数推定誤差（MAE）: 0.131213 Hz
- 周波数推定誤差（最大）: 0.310000 Hz
- 波形再現誤差（RMSE）: 0.513751
- 波形相関係数: 0.890479
- 高周波抑制指標（PRX/PLX差分比）: 0.560046 （小さいほど良い）
- スイッチ有効率: 0.5344
