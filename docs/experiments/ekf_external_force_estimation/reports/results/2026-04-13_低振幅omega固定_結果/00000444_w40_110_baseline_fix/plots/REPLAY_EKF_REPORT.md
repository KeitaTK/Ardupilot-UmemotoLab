# 00000444_w40_110_baseline_fix - EKF リプレイ検証レポート

## 入力データ
- リプレイ結果CSV: docs/experiments/ekf_external_force_estimation/reports/2026-04-13_low_amp_holdomega_fix/00000444_w40_110_baseline_fix/00000444_w40_110_baseline_fix_result.csv
...
- サンプル数: 7000
- 処理時間: 69.99 秒
- 周波数推定誤差（MAE）: 0.108274 Hz
- 周波数推定誤差（最大）: 0.252300 Hz
- 波形再現誤差（RMSE）: 0.357965
- 波形相関係数: 0.936588
- 高周波抑制指標（PRX/PLX差分比）: 0.374939 （小さいほど良い）
- スイッチ有効率: 0.5344
