# 00000443_w35_100_baseline_fix - EKF リプレイ検証レポート

## 入力データ
- リプレイ結果CSV: docs/experiments/ekf_external_force_estimation/reports/2026-04-13_low_amp_holdomega_fix/00000443_w35_100_baseline_fix/00000443_w35_100_baseline_fix_result.csv
...
- サンプル数: 6465
- 処理時間: 64.99 秒
- 周波数推定誤差（MAE）: 0.099506 Hz
- 周波数推定誤差（最大）: 0.310000 Hz
- 波形再現誤差（RMSE）: 0.483994
- 波形相関係数: 0.832558
- 高周波抑制指標（PRX/PLX差分比）: 0.364322 （小さいほど良い）
- スイッチ有効率: 0.6597
