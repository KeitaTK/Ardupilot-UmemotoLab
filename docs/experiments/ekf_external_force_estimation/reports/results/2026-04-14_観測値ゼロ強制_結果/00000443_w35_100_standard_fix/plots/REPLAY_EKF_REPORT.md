# 00000443_w35_100_standard_fix - EKF リプレイ検証レポート

## 入力データ
- リプレイ結果CSV: /home/memoto/Ardupilot-UmemotoLab/docs/experiments/ekf_external_force_estimation/reports/results/2026-04-14_観測値ゼロ強制_結果/00000443_w35_100_standard_fix/00000443_w35_100_standard_fix_result.csv
...
- サンプル数: 6465
- 処理時間: 64.99 秒
- 周波数推定誤差（MAE）: 0.109083 Hz
- 周波数推定誤差（最大）: 0.310000 Hz
- 波形再現誤差（RMSE）: 0.219536
- 波形相関係数: 0.965562
- 高周波抑制指標（PRX/PLX差分比）: 0.350436 （小さいほど良い）
- スイッチ有効率: 0.6597
