# 2026-04-15 Robust+SmoothM30 Raw濃色修正版 - EKF リプレイ検証レポート

## 入力データ
- リプレイ結果CSV: docs/experiments/ekf_external_force_estimation/reports/results/2026-04-15_robust_smooth_m30_concat_direct_replay/replay/00000443_00000444_concat_robust_smooth_m30_result.csv
...
- サンプル数: 13465
- 処理時間: 134.99 秒
- 周波数推定誤差（MAE）: 0.126242 Hz
- 周波数推定誤差（最大）: 0.171600 Hz
- 波形再現誤差（RMSE）: 0.305962
- 波形相関係数: 0.942630
- 高周波抑制指標（PRX/PLX差分比）: 0.116034 （小さいほど良い）
- スイッチ有効率: 0.5946
