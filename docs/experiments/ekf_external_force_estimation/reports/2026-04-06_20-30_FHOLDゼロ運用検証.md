...
- 前レポートからの問題提起: FHOLD=0運用の副作用と有効性が未確定
- 本レポートの解決手法: FHOLD値を0に固定した再実行で差分検証
...
- 前後関係: 前段 [2026-04-06_20:15_RMS閾値推定.md](./2026-04-06_20:15_RMS閾値推定.md) / 次段 [2026-04-06_20:45_XY軸Qw比較.md](./2026-04-06_20:45_XY軸Qw比較.md)
概要
...
python3 analysis/replay/fixed_init_060_qw_sweep.py --replay-bin build/sitl/examples/EKF_CSV_Replay
python3 analysis/replay/x_y_axis_comparison_three_qw.py --replay-bin build/sitl/examples/EKF_CSV_Replay
```
