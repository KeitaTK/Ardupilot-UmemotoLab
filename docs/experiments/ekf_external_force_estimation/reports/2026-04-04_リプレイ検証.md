...
### 2.3 運用シナリオ別の周波数遷移
![Scenario Transitions](../../../../analysis/replay/results/diagnostics/scenario_transition_comparison.png)
...
### 3.1 常時推定モードの特性
![Always-on Time Series](../../../../analysis/replay/results/diagnostics/always_on_integrated_frequency.png)
...
### 3.2 軸ゲートパラメータスキャン結果
![Gate Scan Effects](../../../../analysis/replay/results/diagnostics/section8_gate_scan_parameters.png)
...
### 3.3 改善効果の定量化
![Improvement Analysis](../../../../analysis/replay/results/diagnostics/section8_improvement_analysis.png)
