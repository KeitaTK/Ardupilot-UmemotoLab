...
- 前レポートからの問題提起: X/Y/XYでQw感度が異なり、最適設定が不明
- 本レポートの解決手法: X/Y/XY別にQw依存を比較し設定指針化
...
- 前後関係: 前段 [2026-04-06_20:30_FHOLDゼロ運用検証.md](./2026-04-06_20:30_FHOLDゼロ運用検証.md) / 次段 [2026-04-07_17:10_エネルギーゲート検証.md](./2026-04-07_17:10_エネルギーゲート検証.md)
## 目的
