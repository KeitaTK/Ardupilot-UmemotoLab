...
- 前レポートからの問題提起: 複数方式の優劣を同一窓で比較できていない
- 本レポートの解決手法: 時間窓統一で複数方式を同軸比較しランキング化
...
- 前後関係: 前段 [2026-04-06_17:35_固定060_Qwスイープ.md](./2026-04-06_17:35_固定060_Qwスイープ.md) / 次段 [2026-04-06_20:15_RMS閾値推定.md](./2026-04-06_20:15_RMS閾値推定.md)
## 目的
