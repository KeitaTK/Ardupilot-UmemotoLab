# 00000443_w35_100_model_strong_pred0 - EKF リプレイ検証レポート

## 入力データ
- リプレイ結果CSV: docs/experiments/ekf_external_force_estimation/reports/2026-04-13_443_444リプレイ検証_model_strong/00000443_w35_100_model_strong_pred0/00000443_w35_100_model_strong_pred0_result.csv
...
- サンプル数: 6465
- 処理時間: 64.99 秒
- 周波数推定誤差（MAE）: 0.120061 Hz
- 周波数推定誤差（最大）: 0.250000 Hz
- 波形再現誤差（RMSE）: 2.166855
- 波形相関係数: 0.355396
- 高周波抑制指標（PRX/PLX差分比）: 0.617045 （小さいほど良い）
- スイッチ有効率: 0.6597
