# 00000443_w35_100_model_mid - EKF リプレイ検証レポート

## 入力データ
- リプレイ結果CSV: docs/experiments/ekf_external_force_estimation/reports/2026-04-13_443_444リプレイ検証_model_strong/00000443_w35_100_model_mid/00000443_w35_100_model_mid_result.csv
...
- サンプル数: 6465
- 処理時間: 64.99 秒
- 周波数推定誤差（MAE）: 0.109149 Hz
- 周波数推定誤差（最大）: 0.310000 Hz
- 波形再現誤差（RMSE）: 2.295271
- 波形相関係数: 0.329904
- 高周波抑制指標（PRX/PLX差分比）: 0.559293 （小さいほど良い）
- スイッチ有効率: 0.6597
