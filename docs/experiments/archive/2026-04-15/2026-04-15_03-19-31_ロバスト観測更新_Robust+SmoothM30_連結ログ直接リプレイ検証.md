...
| segment | X RMSE | X MAE | X Corr | Y RMSE | Y MAE | Y Corr | EstFreq mean [Hz] | EstFreq std [Hz] |

|---|---:|---:|---:|---:|---:|---:|---:|

| all | 0.305962 | 0.235555 | 0.942630 | 0.346814 | 0.279042 | N/A | 0.461248 | 0.030995 |

| first (443) | 0.301877 | 0.232422 | 0.928957 | 0.346601 | 0.278573 | N/A | 0.468199 | 0.042155 |

| second (444) | 0.309688 | 0.238450 | 0.950752 | 0.347011 | 0.279477 | N/A | 0.454826 | 0.010986 |
...
![concat direct replay x](results/2026-04-15_robust_smooth_m30_concat_direct_replay/figures/concat_direct_replay_x_raw_vs_est.png)



### Y軸: 生データと推定値（連結ログを直接リプレイ）

![concat direct replay y](results/2026-04-15_robust_smooth_m30_concat_direct_replay/figures/concat_direct_replay_y_raw_vs_est.png)



### 周波数推定: EstFreq_Hz（連結ログを直接リプレイ）

![concat direct replay frequency](results/2026-04-15_robust_smooth_m30_concat_direct_replay/figures/concat_direct_replay_frequency_est_vs_real.png)
