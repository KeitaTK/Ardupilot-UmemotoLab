...
typedef struct __mavlink_autopilot_version_t {
 ...
 uint64_t uid_taki; /*<  UID if provided by hardware (see uid2)*/
 ...
 uint32_t board_version; /*<  HW / board version (last 8 bits should be silicon ID, if any). The first 16 bits of this field specify https://github.com/ardupilot/ardupilot/blob/master/Tools/AP_Bootloader/board_types.txt*/
...
#define MAVLINK_MSG_ID_AUTOPILOT_VERSION_CRC 232
#define MAVLINK_MSG_ID_148_CRC 232
...
#define MAVLINK_MESSAGE_INFO_AUTOPILOT_VERSION { \
    ...
    {  { "capabilities", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_autopilot_version_t, capabilities) }, \
         ...
         { "uid_taki", NULL, MAVLINK_TYPE_UINT64_T, 0, 8, offsetof(mavlink_autopilot_version_t, uid_taki) }, \
 ...
 * @param board_version  HW / board version (last 8 bits should be silicon ID, if any). The first 16 bits of this field specify https://github.com/ardupilot/ardupilot/blob/master/Tools/AP_Bootloader/board_types.txt
 ...
 * @param uid_taki  UID if provided by hardware (see uid2)
 ...
 *
 * @return  HW / board version (last 8 bits should be silicon ID, if any). The first 16 bits of this field specify https://github.com/ardupilot/ardupilot/blob/master/Tools/AP_Bootloader/board_types.txt
 */
...
/**
 * @brief Get field uid_taki from autopilot_version message
 *
 * @return  UID if provided by hardware (see uid2)
 */
static inline uint64_t mavlink_msg_autopilot_version_get_uid_taki(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_autopilot_version_decode(const mavlink_message_t* msg, mavlink_autopilot_version_t* autopilot_version)
{
    ...
    autopilot_version->uid_taki = mavlink_msg_autopilot_version_get_uid_taki(msg);
